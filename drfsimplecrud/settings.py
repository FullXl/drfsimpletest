...
from datetime import timedelta  # Para la configuración de tiempos de vida de los tokens JWT
...
SIMPLE_JWT = {
    ...
    'AUTH_HEADER_TYPES': ('Bearer',),            # Prefijo del encabezado de autorización
}
